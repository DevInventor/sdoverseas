          ...
          <div className="flex items-center gap-4">
              ...
              <div className={`relative hidden sm:block transition-all duration-300 ${
                ...
                <form onSubmit={handleSearchSubmit} className="relative">
                  <input 
                    className={`w-full rounded-full border-2 transition-all duration-300 pl-10 pr-4 py-2.5 text-sm font-medium backdrop-blur-sm ${
                      isSearchFocused 
                        ? 'border-primary bg-white/90 dark:bg-gray-800/90 shadow-lg shadow-primary/20 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400' 
                        : 'border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 placeholder:text-gray-500 dark:placeholder:text-gray-400 hover:border-primary/50 dark:hover:border-primary/50'
                    }`}
                    ...
                    autoComplete="off"
                  />
                  <div className={`absolute inset-y-0 left-0 flex items-center pl-3 transition-colors duration-300 ${
                    isSearchFocused 
                      ? 'text-primary' 
