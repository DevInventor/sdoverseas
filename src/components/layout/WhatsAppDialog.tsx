...
export const WhatsAppDialog: React.FC<WhatsAppDialogProps> = ({
  ...
  return (
    <>
      ...
      <div
        ref={dialogRef}
        className={`fixed bottom-24 left-6 z-50 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 transform ${
          isVisible 
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 bg-green-500 rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <h3 id="whatsapp-dialog-title" className="text-white font-semibold text-lg">
              WhatsApp
            </h3>
          </div>
        ...
        <div className="p-4 pt-0">
          <button
            ...
            className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-4 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
          >
            <svg 
              className="w-5 h-5" 
              viewBox="0 0 24 24" 
